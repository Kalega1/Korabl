<?php 
 ...
 if(isset($_POST['catch_fish'])){
    ...
    $quantity = 1; 
     ...
     // Проверяем, есть ли уже такая рыба в инвентаре пользователя
     $check_sql = "SELECT * FROM user_fish WHERE user_id='$user_id' AND fish_id='$fish_id'";
     $check_result = mysqli_query($connect, $check_sql);

     if(mysqli_num_rows($check_result) > 0){
         // Если рыба уже есть в инвентаре, увеличиваем ее количество на 1
         ...
         // Если рыбы нет в инвентаре, добавляем ее
